...
@section('title')
    Rocket &rarr; {{ $rocket->name }} &rarr; Variables
@endsection

@section('content-header')
    <h1>{{ $rocket->name }}<small>Managing variables for this Rocket.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{ route('admin.launchpads.rocket.variables', $rocket->id) }}">Variables</a></li>
    ...
    @foreach($rocket->variables as $variable)
        <div class="col-sm-6">
            <div class="box">
                ...
                <form action="{{ route('admin.launchpads.rocket.variables.edit', ['rocket' => $rocket->id, 'variable' => $variable->id]) }}" method="POST">
                    <div class="box-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Create New Rocket Variable</h4>
            </div>
            <form action="{{ route('admin.launchpads.rocket.variables', $rocket->id) }}" method="POST">
