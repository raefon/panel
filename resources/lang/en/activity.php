...
return [
    ...
    'server' => [
        ...
        'snapshot' => [
            'download' => 'Downloaded the :name snapshot',
            'delete' => 'Deleted the :name snapshot',
            'restore' => 'Restored the :name snapshot (deleted files: :truncate)',
            'restore-complete' => 'Completed restoration of the :name snapshot',
            'restore-failed' => 'Failed to complete restoration of the :name snapshot',
            'start' => 'Started a new snapshot :name',
            'complete' => 'Marked the :name snapshot as complete',
            'fail' => 'Marked the :name snapshot as failed',
            'lock' => 'Locked the :name snapshot',
            'unlock' => 'Unlocked the :name snapshot',
        ],
        'database' => [
