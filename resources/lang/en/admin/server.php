...
return [
    ...
    'alerts' => [
        'startup_changed' => 'The startup configuration for this server has been updated. If this server\'s launchpad or rocket was changed a reinstall will be occurring now.',
        ...
        'cluster_required' => 'You must have at least one cluster configured before you can add a server to this panel.',
        'transfer_clusters_required' => 'You must have at least two clusters configured before you can transfer servers.',
        'transfer_started' => 'Server transfer has been started.',
        'transfer_not_viable' => 'The cluster you selected does not have the required disk space or memory available to accommodate this server.',
    ],
];
