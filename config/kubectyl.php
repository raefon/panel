...
return [
    ...
    */
    ...
    | standard Kubectyl shipped services.
    */
    ...
    */
    ...
    'paginate' => [
        ...
        'api' => [
            'clusters' => env('APP_PAGINATE_API_NODES', 25),
    ...
    */
    ...
    'cdn' => [
        'cache_time' => 60,
        'url' => 'https://cdn.kubectyl.org/releases/latest.json',
    ],
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('KUBECTYL_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('KUBECTYL_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('KUBECTYL_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('KUBECTYL_CLIENT_ALLOCATIONS_ENABLED', false),
            'range_start' => env('KUBECTYL_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('KUBECTYL_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('KUBECTYL_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('KUBECTYL_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('KUBECTYL_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('KUBECTYL_SEND_REINSTALL_NOTIFICATION', true),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | This section controls the telemetry sent by Kubectyl.
    */

    'telemetry' => [
        'enabled' => env('KUBECTYL_TELEMETRY_ENABLED', true),
    ],
];
