...
use Kubectyl\Models\Filters\MultiFieldServerFilter;
use Kubectyl\Transformers\Api\Client\ServerTransformer;
use Kubectyl\Http\Requests\Api\Client\GetServersRequest;
...
class ClientController extends ClientApiController
{
    ...
    public function index(GetServersRequest $request): array
    {
        ...
        $builder = QueryBuilder::for(
            Server::query()->with($this->getIncludesForTransformer($transformer, ['cluster']))
        )->allowedFilters([
            'uuid',
            'name',
            'description',
