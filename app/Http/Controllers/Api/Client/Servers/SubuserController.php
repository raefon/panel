...
use Kubectyl\Transformers\Api\Client\SubuserTransformer;
...
use Kubectyl\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use Kubectyl\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use Kubectyl\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use Kubectyl\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \Kubectyl\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \Kubectyl\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \Kubectyl\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
