...
use Kubectyl\Transformers\Api\Client\ScheduleTransformer;
use Kubectyl\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Kubectyl\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use Kubectyl\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use Kubectyl\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use Kubectyl\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use Kubectyl\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    {
        /** @var \Kubectyl\Models\Schedule $model */
