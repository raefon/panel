...
namespace Kubectyl\Extensions\Spatie\Fractalistic;
...
use Kubectyl\Extensions\League\Fractal\Serializers\KubectylSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new KubectylSerializer();
        }
